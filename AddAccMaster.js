          ...
          <div className="col-5">
            ...
            <div className="row" >
              <div className="col-12">
                <button className="note-btn px-3 mx-1"  onKeyDown={handleEnter}>
                  <b>Notes</b>
                </button>
                <button className="note-btn px-2 mx-1" onKeyDown={handleEnter}>
                  <b>Opt. Fields</b>
                </button>
                <button className="note-btn px-3 mx-1" onKeyDown={handleEnter}>
                  <b>Multiple Alias</b>
                </button>
                <button className="Acc-btn px-3 mx-1" onKeyDown={handleEnter}>
                  <b>Acc IMAGE</b>
                </button>
              </div>
            </div>
